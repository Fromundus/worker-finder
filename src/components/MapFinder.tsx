...
// Ensure default marker images are available
...
// function makeDivIcon(label?: string) {
//   return L.divIcon({
//     className: "custom-map-marker",
//     html: `<div style="display:flex;align-items:center;gap:6px">
//              <div style="background:#2563eb;color:white;padding:4px 8px;border-radius:6px;font-size:12px;font-weight:600">${label ?? ""}</div>
//              <div style="width:18px;height:18px;border-radius:50%;background:#1f2937;border:2px solid #fff;"></div>
//            </div>`,
//     iconSize: [120, 36],
//     iconAnchor: [60, 18],
//   });
